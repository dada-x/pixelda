...
| 功能                                | 提供商         | 版本                                             |
| ----------------------------------- | -------------- | ------------------------------------------------ |
| 图像生成                            | 通义千问, 豆包 | wan2.2-t2i-flash, doubao-seedream-4-0-250828     |
| 视频生成                            | 通义千问, 豆包 | wan2.2-i2v-flash, doubao-seedance-1-0-pro-250528 |
| 基于聊天的音乐生成(MAx Tokens:2048) | 通义千问, 豆包 | qwen-plus, doubao-seed-1-6-251015                |
