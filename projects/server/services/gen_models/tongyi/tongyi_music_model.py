...
class TongyiMusicService(BaseMusicService):

    def __init__(self):
        super().__init__()
        self.base_url = "https://ark.cn-beijing.volces.com/api/v3"
        self.model = DEFAULT_TONGYI_CHAT_MODEL
    ...
    def _execute_request(
        self, params: Dict[str, Any], operation: str
    ) -> tuple[str, str]:
        try:
    ...
    def generate_music(
        ...
        result = self._execute_request(params, operation)

        return result


_service = TongyiMusicService()


def tongyi_gen_abc_music(request: MusicGenerationRequest) -> tuple[str, str]:
